        ...
        <div className="row g-0 auth-wrapper">
            ...
            <div className="col-12 col-md-5 col-lg-6 h-100 auth-background-col">
                ...
                <div className="auth-background-holder">
                    <h1 className="auth-background" id="titlecard">The ShitList™</h1>
                </div>
            ...
            <div className="col-12 col-md-7 col-lg-6 auth-main-col text-center">
                <div className="d-flex flex-column align-content-end">
                    <div className="auth-body mx-auto ">
                        <img src="https://i.pinimg.com/originals/cc/40/6a/cc406a8382d8df7eb5f395ec884d3c95.png" style={{backgroundColor: "lightblue", maxWidth: "50%", marginBottom: "5%"}} />
